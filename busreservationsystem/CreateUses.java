...
public class CreateUses extends javax.swing.JPanel{
    ...
    void con(){
        ...
        try(Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/busmanagementsystem", "root", "Prakhar@123");
         ...
         String sql = "INSERT INTO users VALUES ('"+fNameT.getText()+"', '"+lNameT.getText()+"','"+fullDate+"','"+phNoT.getText()+"', '"+emailT.getText()+"','"+passwardT.getText()+"')";
